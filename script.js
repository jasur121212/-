...
const songs = [
  {
    title: "HIM ",
    name: "Join Me",
    source: "song-list/HIM - Join Me (Razorblade Mix).mp3",
  },
  {
    title: "Deftones",
    name: "Xerces",
    source: "song-list/07. Xerces   Deftones.mp3",
  },
  {
    title: "ECCO2K ",
    name: "ECCO2K - Hold Me Down Like Gravity",
    source: "song-list/hold me down like gravity [prod. white armor   yung sherman].mp3",
  },
  {
    title: "Bladee",
    name: "Lovenote",
    source: "song-list/Lovenote   Bladee.mp3",
  },
  {
    title: "xaviersobased",
    name: "love hate",
    source: "song-list/xaviersobased - love hate (hadif10k).mp3",
  },
  {
    title: "Yung Lean(feat. Bladee)",
    name: "Hennessy   Sailor Moon",
    source: "song-list/Hennessy   Sailor Moon (feat. Bladee)   Yung Lean.mp3",
  },
  {
    title: "sad girl",
    name: "Lana Del Rey",
    source: "song-list/j96-tzqIS_4.mp3",
  },
];
